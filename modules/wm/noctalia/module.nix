...
#          variant = "colemak_dh";
    ...
    systemd.tmpfiles.rules = [
      "L+ /var/lib/AccountsService/icons/jawknee - - - - ${shinchan pkgs}"
      "f+ /var/lib/AccountsService/users/jawknee 0644 root root - [User]\\nIcon=/var/lib/AccountsService/icons/jawknee\\n"
    ];
  };
