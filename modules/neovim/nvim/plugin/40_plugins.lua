...
now_if_args(function()
  ...
  local servers = {
    ...
    nixd = {
      ...
      --     options = {
      --       nixos = {
      --         expr = '(builtins.getFlake "/home/jawknee/etc/nixos").nixosConfigurations.nixpavilion.options',
      --       },
      --       home_manager = {
      --         expr = '(builtins.getFlake "/home/jawknee/etc/nixos").homeConfigurations.jawknee.options',
      --       },
      --     },
      --   },
      -- },
